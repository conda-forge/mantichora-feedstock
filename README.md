About mantichora-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mantichora-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6363&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mantichora-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mantichora` can be installed with `conda`:
...
```
mamba install mantichora
```

It is possible to list all of the versions of `mantichora` available on your platform with `conda`:
...
```
mamba search mantichora --channel conda-forge
```
...
mamba repoquery search mantichora --channel conda-forge

# List packages depending on `mantichora`:
mamba repoquery whoneeds mantichora --channel conda-forge

# List dependencies of `mantichora`:
mamba repoquery depends mantichora --channel conda-forge
```
